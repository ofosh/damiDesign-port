...
const About = () => {
  const stats = [
    ...
    { icon: <Lightbulb size={32} />, number: '100+', label: 'Creative Solutions' },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-slate-600 mb-8 leading-relaxed">
              I'm a passionate designer with over 5 years of experience creating digital experiences 
              that not only look amazing but also drive results. My approach combines creative vision 
              with strategic thinking to deliver solutions that exceed expectations.
            </p>
            <p className="text-lg text-slate-600 mb-8 leading-relaxed">
              From concept to completion, I work closely with clients to understand their unique needs 
              and translate them into compelling visual stories. Every project is an opportunity to 
