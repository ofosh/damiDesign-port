  ...
  const testimonials = [
    {
      ...
      content: 'Working with DamiDesign transformed our brand completely. The attention to detail and creative vision exceeded all our expectations. Our conversion rates increased by 40% after the redesign.',
      rating: 5,
    },
    {
      id: 2,
      ...
      content: 'The mobile app design delivered by DamiDesign was exceptional. User engagement increased by 60% and the feedback has been overwhelmingly positive. Highly professional service.',
      rating: 5,
    },
    {
      id: 3,
      ...
      content: 'Dami understood our vision perfectly and brought it to life with stunning design work. The brand identity package was comprehensive and beautifully executed. Outstanding results.',
      rating: 5,
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Don't just take my word for it. Here's what clients say about working with DamiDesign 
        ...
        <div className="mt-20 grid md:grid-cols-4 gap-8 text-center">
          ...
          <div className="group">
            <div className="text-4xl font-bold text-orange-500 mb-2 group-hover:scale-110 transition-transform duration-300">24h</div>
